...
function setcolor(){
    ...
    if(getCookie('color') == 0){
        ...
        document.getElementById('flappy').style.color = color;
        document.getElementById('pok').style.color = color;
        document.getElementById('zom').style.color = color;
        document.getElementById('tic').style.color = color;
...
function changetheme(){
    ...
    document.getElementById('between2').style.color= revtheme;
    document.getElementById('flappybt').style.color= revtheme;
    document.getElementById('flappydes').style.color= revtheme;
    document.getElementById('pokbt').style.color= revtheme;
    document.getElementById('pokdes').style.color= revtheme;
    document.getElementById('zombt').style.color= revtheme;
    document.getElementById('zomdes').style.color= revtheme;
