...
function setcolor(){
    ...
    if(getCookie('color') == 0){
        ...
        document.getElementsByTagName('b')[0].style.color = color;
        document.getElementsByTagName('b')[1].style.color = color;
        document.getElementsByTagName('b')[2].style.color = color;
        document.getElementsByTagName('b')[3].style.color = color;
        document.getElementsByTagName('b')[4].style.color = color;
        document.getElementsByTagName('b')[5].style.color = color;
        document.getElementsByTagName('b')[6].style.color = color;
