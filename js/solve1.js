...
function changetheme(){
    ...
    document.getElementById('bmides').style.color= revtheme;
    document.getElementById('weight').style.color= revtheme;
    document.getElementById('height').style.color= revtheme;
    document.getElementById('bmires').style.color= revtheme;
    document.getElementById('bmibt').style.color= revtheme;
