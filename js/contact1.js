...
if(getCookie('theme')=='1'){
    ...
    document.getElementById('instaimg').src = '../Images/instaw.png'
    document.getElementById('gitimg').src = '../Images/gitw.png'
    revtheme = 'white'
}
else{
    theme = 'white'
    ...
    document.getElementById('instaimg').src = '../Images/instab.png'
    document.getElementById('gitimg').src = '../Images/gitb.png'
    revtheme = 'black'
}
changetheme()
function changetheme(){
    ...
    document.getElementById('contactme').style.color= revtheme;
